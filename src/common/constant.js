...
const UPLOAD_PATH = {
  image: 'http://10.31.3.97:8300/library/upload',
  formula: 'http://10.31.3.97:8300/library/uploadSvg',
};

export { RESPONSE_STATUS, AUTHORITY_TOKEN, TARGET_TYPE, SUBJECTS, SCOPE, DEPARTMENTS, UPLOAD_PATH };
