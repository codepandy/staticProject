...
import { getBschoolList } from './mock/bschool';
...
const proxy = {
  ...
  'GET /api/bcStudentActivityRecord': getBcStudentlList,
  // 支持值为 Object 和 Array
  'GET /api/currentUser': {
    $desc: '获取当前用户接口',
    $params: {
...
const serviceUrl = 'http://10.31.3.97:8300/library';
export default (noProxy
  ? {
      'GET /library/(.*)': serviceUrl,
      'POST /library/(.*)': serviceUrl,
    }
  : delay(proxy, 1000));
